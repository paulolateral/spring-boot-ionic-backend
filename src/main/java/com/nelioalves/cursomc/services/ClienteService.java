...
public class ClienteService {
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		...
		Endereco end = new Endereco(null, objDto.getLogradouro(), objDto.getNumero(), objDto.getComplememto(), objDto.getBairro(), objDto.getCep(), cli, cid);
	...
	public URI uploadProfilePicture(MultipartFile multipartFile) {
		...
		URI url = s3Service.uploadFile(imageService.getInputStream(jpgImage, "jpg"), fileName, "image");
		return url;
	...
	public Cliente findByEmail(String email) {
		...
		if (obj == null) {
			throw new ObjectNotFoundException("Obmjeto não encontrado! Id: " + user.getId() + ", Tipo: " + Cliente.class.getName());
		}
		return obj;
	}
}
